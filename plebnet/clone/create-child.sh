...
sshpass -p${PASSWORD} ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no root@${IP} "wget https://raw.githubusercontent.com/Tribler/Dollynator/$BRANCH/plebnet/clone/install.sh && \
    chmod +x install.sh && \
