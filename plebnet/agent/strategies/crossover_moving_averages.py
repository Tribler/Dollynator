...
log_name = "agent.strategies.crossovers_moving_averages"


class CrossoversMovingAverages(Strategy):
    """
    ...
    def read_last_iteration_info(self):
        ...
        filename = os.path.join(config_dir, 'crossovers_moving_averages.json')
