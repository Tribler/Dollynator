...
def put_ask(price, price_type, quantity, quantity_type):
    return _put_request(price, price_type, quantity, quantity_type, 'asks')


def put_bid(price, price_type, quantity, quantity_type):
    return _put_request(price, price_type, quantity, quantity_type, 'bids')


def _put_request(price, price_type, quantity, quantity_type, domain):
