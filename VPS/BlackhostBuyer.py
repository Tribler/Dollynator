...
class BlackhostBuyer(VPSBuyer):
    ...
    def buy(self):
        ...
        self._fill_in_element('[name="ns1prefix"]', self.generator.get_first_name())
        self._fill_in_element('[name="ns2prefix"]', self.generator.get_first_name())
        ...
        self._fill_in_element('[name="password"]', self.generator.get_password())
        self._fill_in_element('[name="password2"]', self.generator.get_password())
        self._fill_in_element('[name="securityqans"]', self.generator.get_first_name())
