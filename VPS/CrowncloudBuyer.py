...
class CrowncloudBuyer(VPSBuyer):
    ...
    def buy(self):
        ...
        self._choose_select_element("tbody > tr:first-child > td.fieldarea > select.form-control", "Ubuntu 16.04 64bit")
        ...
        self._fill_in_element('div.row > div:nth-of-type(1) > div:nth-of-type(5) > input.form-control',
                              self.generator.get_password())
        self._fill_in_element('#inputNewPassword2',
                              self.generator.get_password())
        self._fill_in_element('div.row > div:nth-of-type(2) > div:nth-of-type(1) > input.form-control',
                              self.generator.get_random_alphabetical_string(10))
        self._fill_in_element('#city', self.generator.get_random_alphabetical_string(10))
        ...
        self._click_select_element('[name="gateway"]', "Bit-pay (Bitcoin)")
        self.driver.implicitly_wait(5)
