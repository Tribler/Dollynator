...
class RamNodeBuyer(VPSBuyer):
    ...
    def buy(self):
        ...
        self._choose_select_element('tbody > tr:first-child > td.fieldarea > select', "Ubuntu 16.04 64-bit")
        ...
        self._fill_in_element('tbody > tr:nth-of-type(6) > td:nth-of-type(2) > input', self.generator.get_password())
        self._fill_in_element('tbody > tr:first-child > td:nth-of-type(4) > input', self.generator.get_random_alphabetical_string(10))
        self._fill_in_element('[name="city"]', self.generator.get_city())
        self._fill_in_element('[name="postcode"]', self.generator.get_zipcode())
        self._choose_select_element('#country', "Netherlands")
        self._choose_select_element('#stateselect', "Limburg")
        self._fill_in_element('[name="phonenumber"]', self.generator.get_phone_num())
        self._fill_in_element('[name="securityqans"]', self.generator.get_random_alphabetical_string(10))
        self._choose_select_element('tbody > tr:nth-of-type(10) > td.fieldarea > select.form-control', "Google")
